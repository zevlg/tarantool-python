...
class Test_RequestInsert15(unittest.TestCase):
    def setUp(self):
        self.conn1 = ConnectionMock(tarantool.lts.NUM)
        self.conn2 = ConnectionMock(tarantool.lts.STR)
    ...
    def test__cast_to_bytes(self):
        ...
        '''
        self.assertEqual(
            bytes(tarantool.lts.request.RequestInsert(self.conn1, 1, (1, 2000, 30000), False)),
            binascii.unhexlify("0d0000001b00000000000000010000000000000003000000040100000004d00700000430750000")
        )

        self.assertEqual(
            bytes(tarantool.lts.request.RequestInsert(self.conn2, 1, (b"AAA", b"BBBB", b"CCCCCC"), False)),
            binascii.unhexlify("0d0000001c0000000000000001000000000000000300000003414141044242424206434343434343")
        )

class Test_RequestDelete15(unittest.TestCase):
    def setUp(self):
        self.conn1 = ConnectionMock(tarantool.lts.NUM)
        self.conn2 = ConnectionMock(tarantool.lts.STR)
    ...
    def test__cast_to_bytes(self):
        ...
        '''
        self.assertEqual(
            bytes(tarantool.lts.request.RequestDelete(self.conn1, 1, 1, False)),
            binascii.unhexlify("1500000011000000000000000100000000000000010000000401000000")
        )

        self.assertEqual(
            bytes(tarantool.lts.request.RequestDelete(self.conn2, 1, b"AAA", False)),
        ...
        with self.assertRaises(TypeError):
            tarantool.lts.request.RequestDelete(1, [1,2], False)


class Test_RequestSelect15(unittest.TestCase):
    def setUp(self):
        self.conn1 = ConnectionMock(tarantool.lts.NUM)
        self.conn2 = ConnectionMock(tarantool.lts.STR)
    ...
    def test__cast_to_bytes(self):
        ...
        self.assertEqual(
            bytes(tarantool.lts.request.RequestSelect(self.conn1, 1, 0, [(1,)], 0, 0xffff)),
        ...
        self.assertEqual(
            bytes(tarantool.lts.request.RequestSelect(self.conn2, 1, 0, [(b"AAA",)], 0, 0xffff)),
        ...
        self.assertEqual(
            bytes(tarantool.lts.request.RequestSelect(self.conn1, 1, 0, [(1,), (2,), (3,)], 0, 0xffff)),
        ...
        self.assertEqual(
            bytes(tarantool.lts.request.RequestSelect(self.conn1, 1, 0, [(1, 2)], 0, 0xffff)),
        ...
        self.assertEqual(
            bytes(tarantool.lts.request.RequestSelect(self.conn1, 1, 0, [(1, 2), (3, 4)], 0, 0xffff)),
...
class Test_RequestUpdate15(unittest.TestCase):
    def setUp(self):
        self.conn = ConnectionMock(tarantool.lts.NUM)
    ...
    def test__cast_to_bytes(self):
        ...
        self.assertEqual(
            bytes(tarantool.lts.request.RequestUpdate(self.conn, 0x11, 0x22, [(0x33, '=', 0x11223344)], False)),
        ...
        self.assertEqual(
            bytes(tarantool.lts.request.RequestUpdate(self.conn, 0x11, b"ZZZZZZ", [(0x33, '=', 0x11223344)], False)),
        ...
        self.assertEqual(
            bytes(tarantool.lts.request.RequestUpdate(self.conn, 0x11, 0x22, [(0x33, '=', b"NNN")], False)),
        ...
        self.assertEqual(
            bytes(tarantool.lts.request.RequestUpdate(self.conn, 0x11, b"ZZZZZZ", [(0x33, '=', b"NNN")], False)),
        ...
        self.assertEqual(
            bytes(tarantool.lts.request.RequestUpdate(self.conn, 0x11, 0x22, [(0x33, '=', 0x3333), (0x44, '=', 0x4444), (0x55, '=', 0x5555)], False)),
        ...
        self.assertEqual(
            bytes(tarantool.lts.request.RequestUpdate(self.conn, 0x11, "ZZZZZZ", [(0x33, '=', 0x3333), (0x44, '=', 0x4444), (0x55, '=', 0x5555)], False)),
        ...
        self.assertEqual(
            bytes(tarantool.lts.request.RequestUpdate(self.conn, 0x11, 0x22, [(0x33,'=', b"KKK"), (0x44,'=', b"LLL"), (0x55,'=', b"MMM")], False)),
        ...
        self.assertEqual(
            bytes(tarantool.lts.request.RequestUpdate(self.conn, 0x11, b"ZZZZZZ", [(0x33,'=', b"KKK"), (0x44,'=', b"LLL"), (0x55,'=', b"MMM")], False)),
        ...
        self.assertEqual(
            bytes(tarantool.lts.request.RequestUpdate(self.conn, 0x11, 0x22, [(0x33, '+', 0x55)], False)),
